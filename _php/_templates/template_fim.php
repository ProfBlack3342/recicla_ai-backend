...
<!DOCTYPE html>
    <!--Código específico de cada página aqui-->
        ...
        <footer>
            <div id=<?php echo $id_contatos;?>>
                <h2>Contato:</h2>
                <hr>
            </div>
            <div id=<?php echo $id_mapa;?>>
                <h2>Localização</h2>
                <iframe src=<?php echo $link_mapa;?> width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <div id=<?php echo $id_redes;?>>
                <h2>Redes Sociais</h2>
                <a href=<?php echo $link_face;?> target="_blank" rel="noreferrer noopener"><img src=<?php echo $caminho_logo_face;?> alt=<?php echo $texto_alt_face;?>></a>
                <a href=<?php echo $link_insta;?> target="_blank" rel="noreferrer noopener"><img src=<?php echo $caminho_logo_insta;?> alt=<?php echo $texto_alt_insta;?>></a>
                <a href=<?php echo $link_twitter;?> target="_blank" rel="noreferrer noopener"><img src=<?php echo $caminho_logo_twitter;?> alt=<?php echo $texto_alt_twitter;?>></a>
            </div>
            <hr>
            <div id=<?php echo $id_fim;?>>
